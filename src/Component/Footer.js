            ...
            <footer aria-label="Site Footer" className="bg-white dark:bg-gray-900">
                <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8">
                    <div className="lg:flex lg:items-center lg:justify-between">
                        ...
                        <p
                            className="mt-4 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:text-left lg:mt-0"
                        >
                            Have a question in mind ? Feel free to contact us. We’ll get back to you soon.
                        </p>
                    </div>

                    <div
                        className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-100 pt-16 dark:border-gray-800 md:grid-cols-4 lg:grid-cols-6"
                    >
                        ...
                        <div className="text-center sm:text-left md:col-span-4 lg:col-span-2">
                            ...
                            <div className="mx-auto mt-8 max-w-md sm:ml-0">
                                <p
                                    className="text-center leading-relaxed text-gray-500 dark:text-gray-400 sm:text-left"
                                >
                                    Or reach us at
                                    contactvision@exmail.com
                                </p>
                                ...
                                <form className="mt-4">
                                    ...
                                    >
                                        ...
                                        <input
                                            className="w-full rounded border-gray-200 bg-white px-6 py-3 shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white"
                                            type="email"
                                            placeholder="Enter your email"
                                        />

                                        <button
                                            className="block rounded bg-indigo-500 px-8 py-3 font-medium text-white transition hover:bg-indigo-600"
                                            type="submit"
                                        >
                                            Subscribe
                                        </button>
                    ...
                    <div
                        className="mt-16 border-t border-gray-100 pt-6 dark:border-gray-800 sm:flex sm:items-center sm:justify-between"
                    >
                        <p
                            className="text-center text-sm text-gray-500 dark:text-gray-400 sm:text-left"
                        >
